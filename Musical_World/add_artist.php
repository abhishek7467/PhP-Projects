...
if (($_SERVER['REQUEST_METHOD'] == 'POST') && (!empty($_SERVER['REQUEST_METHOD'] == 'POST'))) {
    ...
    $Artist_Photo_file_name = $_FILES['Artist_Photo']['name'];
    $Artist_Photo_file_temp_name = $_FILES['Artist_Photo']['tmp_name'];
    $Artist_Photo_file_type = $_FILES['Artist_Photo']['type'];
    $Artist_Photo_file_size = $_FILES['Artist_Photo']['size'];

    $Artist_Photo_binary_data = base64_encode(file_get_contents($Artist_Photo_file_temp_name));
    $Artist_Photo_url = 'data:' . $Artist_Photo_file_type . ';base64,' . $Artist_Photo_binary_data;

   

    $Insert_artist = "INSERT INTO `Artist` ( `ArtistName`, `ArtistImage` ) VALUES ( '$Artist_Name','$Artist_Photo_url')";
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
            <div class="">
                <div class=" col-md-4 mb-3">
                    ...
                    <input type="Artist_Name" class="form-control" id="Artist_Name" name="Artist_Name">
                </div>
                <div class="col-md-6 mb-3">
                    <label for="Artist_Photo" class="form-label">Artist Photo</label>
                    <input type="file" class="form-control" id="Artist_Photo" name="Artist_Photo"
