...
<body>
    ...
    <div class="container-buttons">
        <a class="song_playlist" id="remove_song" href="playlist.php">Your Playlist</a>
            ...
            <li class="list-group-item d-flex justify-content-between align-items-start">
                ...
                <span class="badge bg-primary rounded-pill">
                    <button class="add-button" data-item-id="<?php echo $ID; ?>">
                        <div id="response<?php echo $ID; ?>">Remove</div>
                    </button>
                </span>
            </li>
        </ol>
    ...
    document.querySelectorAll('.add-button').forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            RemoveSong(this, Song_id);
        });
    });

    function RemoveSong(button, Song_id) {
        // Make an AJAX request to remove the item with its ID
        var xhr = new XMLHttpRequest();
        xhr.open('POST', 'RemoveToPlayList.php', true);
